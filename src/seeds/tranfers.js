...
exports.seed = (knex) => {
  ...
  return knex('transactions').del()
    ...
    //Povoando as tabelas com dados
    .then(() => knex('users').insert([
      {id: 10000, name:'User 1#', email:'user1@email.com', password:'$2a$10$ObGju7jdrg9E4BjnqxA3Y.qySwVy6cuNfOsYeXkNIsvfDelmVDifC'},
      {id: 10001, name:'User 2#', email:'user2@email.com', password:'$2a$10$ObGju7jdrg9E4BjnqxA3Y.qySwVy6cuNfOsYeXkNIsvfDelmVDifC'}
    ]))
    ...
    .then(() => knex('transfers').insert([
      {id:10000, description:'Tranfer #1', user_id:10000, acc_ori_id:10000, acc_dest_id:10001, ammount: 100, date: new Date()},  
      {id:10001, description:'Tranfer #1', user_id:10001, acc_ori_id:10002, acc_dest_id:10003, ammount: 100, date: new Date()},   
    ]))
